...
1) Имплементируем интерфейс Cloneable
2) Переопределяем clone()
 */
...
//        return (MyObject)super.clone();
        ...
        myObject.newObject = newObject.clone();//клонируем все внутренние ссылочные объекты
        return myObject;//помещаем в новый объект и возвращаем его
    }
}

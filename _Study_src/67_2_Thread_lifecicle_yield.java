...
myThread.setPriority(7); - назначаем приоритет потокам
MAX_PRIORITY = 1
NORM_PRIORITY = 5
MAX_PRIORITY = 10
Голодание потоков - если какокй-то поток в приоритете, то другим не хватает времени, какие-то ресурсы
могут быть заблокированы.
Метод yield говорит scheduler, чтобы он запустил другой поток, так как этот поток завершил свою работу
